...
/**
* get_val - func gets relative value of a card from its string value
*
* @str: the string value of the card
*
* Return: return the relative value of the card (0 through 12)
*/
...
/**
* swap_node - this func swaps a node with the next node in the list
*
...
/**
* sort_deck - func sorts a linked list deck of cards
*
* @deck: a double pointer to the deck to sort
*
* Return: return void
*/
